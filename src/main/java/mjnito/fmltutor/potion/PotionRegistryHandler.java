...
public class PotionRegistryHandler {
    ...
    public static final PotionType POTION_TYPE_DIRT_PROTECTION =
            new PotionType(FMLTutor.MODID +".dirtProtection",new PotionEffect(POTION_DIRT_PROTECTION,3600)).setRegistryName("dirt_protection");
    public static final PotionType POTION_TYPE_LONG_DIRT_PROTECTION=
            new PotionType(FMLTutor.MODID +".dirtProtection",new PotionEffect(POTION_DIRT_PROTECTION,9600)).setRegistryName("long_dirt_protection");
    public static final PotionType POTION_TYPE_STRONG_DIRT_PROTECTION=
            new PotionType(FMLTutor.MODID +".dirtProtection",new PotionEffect(POTION_DIRT_PROTECTION,1800,1)).setRegistryName("strong_dirt_protection");
